...
def normal_info(true_label, predict_data):
    # print(true_label)
    # print(predict_data)
...
def remix_info(outputs, val_labels, label_list, likelihood_list, pred_list, val_label_list):
    ...
    for i in range(len(val_labels)):
        ...
        return pred_list, val_label_list